...
<div role="navigation">
		...
		<div class="collapse navbar-collapse" id="navbarColor03">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a class="nav-link" href="/payment"
					style="font-size: 10px">Membership Renewal<span class="sr-only">(current)</span></a>
				</li>
	...
	<div class="container">
		<h3
			style="font-family: Roboto, sans-serif; color: white; font-size: 25px; font-weight: bold;">
			Enter Weekly Exercise</h3>
		<form class="form-horizontal" method="post" action="addExercise">
			<div class="row ">
			<input type="date" name="dateWeek" /> Choose week starting:
				<div class="col-sm-12">
					<div class="row">
						<div class="col-xs-4">

							<input style="color: white;" type="checkbox" name="day"
								value="Sunday" checked><span>Sunday</span><br> 
							<div align="left">
								<label class="exer" style="color: white;">Enter Time
				...
				<div class="col-sm-12">
					<div class="row">
						<div class="col-xs-4">
						<input style="color: white;" type="checkbox" name="day1" value="Monday" checked><span>Monday</span><br>
				...
				<div class="col-sm-12">
					<div class="row">
						<div class="col-xs-4">
							...
							<input style="color: white;" type="checkbox" name="day2"
				...
				<div class="col-sm-12">
					<div class="row">
						<div class="col-xs-4">
						<input style="color: white;" type="checkbox" name="day4" value="Wednesday" checked><span>Wednesday</span><br>
				...
				<div class="col-sm-12">
					<div class="row">
						<div class="col-xs-4">
						<input style="color: white;" type="checkbox" name="day5" value="Thursday" checked><span>Thursday</span><br>
				...
				<div class="col-sm-12">
					<div class="row">
						<div class="col-xs-4">
						<input style="color: white;" type="checkbox" name="day5" value="Friday" checked><span>Friday</span><br>
				...
				<div class="col-sm-12">
					<div class="row">
						<div class="col-xs-4">
						<input style="color: white;" type="checkbox" name="day6" value="Saturday" checked><span>Saturday</span><br>
